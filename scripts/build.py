    ...
    for name, lift, arm, perception in (
        ...
        dump(
            root / "skill.yaml",
            {
                "manifest_version": 2,
                "name": name,
                "version": "0.1.20" if arm else "0.1.1",
